...
from src.models import (  # noqa: E402
    Community, Event, EventStatus, LocationType, Membership, MembershipRole,
    MembershipStatus, Organization, PlatformRole, PointRule, Profile, Task,
    TaskAssignment, TicketType, TicketVisibility, User,
)
...
def main() -> None:
    ...
    with Session(engine) as db:
        ...
        db.add_all([participant, organizer]); db.flush()
        ...
        db.add(TicketType(event_id=event.id, name="Free admission", description="No-cost entry", price=0,
