...
def create_app() -> FastAPI:
    ...
    application.include_router(opportunities_router, prefix=settings.api_v1_prefix)
    application.include_router(notification_configuration_router, prefix=settings.api_v1_prefix)
